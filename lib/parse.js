...
module.exports = function ($child, root, collectError, rule, ops) {
    ...
    checker.attrRule.apply(checker, args.concat(rule.attrRule, style, ops));

    checker.styleRule.apply(checker, args.concat(rule.styleRule, style, ops));
    //回写样式
